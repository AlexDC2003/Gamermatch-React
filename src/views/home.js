      ...
      <div data-role="Header" className="home-header-container">
        <header className="home-header">
          ...
          <div className="home-menu">
            <span className="home-text">Cash Matches</span>
      ...
      <div className="home-main">
        ...
        <div className="home-hero">
          <div className="home-container07">
            <img
              alt="image"
              src="/playground_assets/fortnite-ruby-skin-featured-700h.png"
      ...
      <div className="home-clients">
        ...
        <div className="home-stats">
          <div className="home-stat">
            ...
            <span className="home-text17">Played Matches</span>
          ...
          <div className="home-stat2">
            ...
            <span className="home-text27">Support</span>
        ...
        <footer className="home-container08">
          ...
          <div className="home-container10">
            <span className="home-text32 body2">
              © 2020 Gamermatch LLC. All rights reserved
            </span>
